...
library = {
    ...
    "segment_end_pos":  lambda s: calc_segment_end_pos(get_segment(s, read_command(s)))
}

for prop in PROPS_ALL:
    library[prop] = seg_prop(prop)

misc_kw = {"begin", "duration", "content_dur"}
