...
class LoopChances:
    def __init__(self, parent):
        m_loc = loc["tab_pattern"]
        self.root = ttk.LabelFrame(parent, text=m_loc["f_loop_chances"], padding=3)

        self.l_pattern = ttk.Label(self.root, text=m_loc["l_pattern"])
        ...
        self.l_count_full_length = ttk.Label(self.root, text=m_loc["l_count_full_length"])
        ...
        self.l_count_pause_length = ttk.Label(self.root, text=m_loc["l_count_pause_length"])
        ...
        self.l_count_pattern_length = ttk.Label(self.root, text=m_loc["l_count_pattern_length"])
        ...
        self.l_break_skips = ttk.Label(self.root, text=m_loc["l_break_skips"])
        ...
        self.l_break_pattern = ttk.Label(self.root, text=m_loc["l_break_pattern"])
        ...
        self.l_break_avgstart = ttk.Label(self.root, text=m_loc["l_break_avgstart"])
...
class LoopSkipVariant:
    def __init__(self, parent):
        ...
        self.l_weight = ttk.Label(self.root, text=m_loc["l_direction_weight"])
        self.e_weight = XEntry(self.root, width=6)
        self.l_weight.grid(row=0, column=0, sticky="w")
        self.e_weight.grid(row=0, column=1, pady=1)

        self.l_min_skip = ttk.Label(self.root, text=m_loc["l_min_skip"])
        self.e_min_skip = XEntry(self.root, width=6)
        self.l_min_skip_chance = ttk.Label(self.root, text=m_loc["l_min_skip_chance"])
        ...
        self.l_add_dev = ttk.Label(self.root, text=m_loc["l_add_dev"])
        self.e_add_dev = XEntry(self.root, width=6)
        self.l_add_dev_chance = ttk.Label(self.root, text=m_loc["l_add_dev_chance"])
...
class LoopSkipping:
    def __init__(self, parent):
        m_loc = loc["tab_pattern"]
        self.root = ttk.LabelFrame(parent, text=m_loc["f_loop_skipping"], padding=3)

        self.l_chance = ttk.Label(self.root, text=m_loc["l_skip_chance"])
        ...
        self.f_modes.add(self.f_forw.root, text=m_loc["t_skip_forw"])
        self.f_modes.add(self.f_back.root, text=m_loc["t_skip_back"])
        self.f_modes.add(self.f_rand.root, text=m_loc["t_skip_rand"])
...
class SubLoop:
    def __init__(self, parent):
        ...
        self.root = ttk.LabelFrame(parent, text=m_loc["f_loop"], padding=3)
        self.f_chances = LoopChances(self.root)
        self.f_skipping = LoopSkipping(self.root)
        self.l_loop_begin = ttk.Label(self.root, text=m_loc["l_loop_begin"])
...
class SubAST:
    def __init__(self, parent):
        m_loc = loc["tab_pattern"]
        self.root = ttk.LabelFrame(parent, text=m_loc["f_loop_ast"], padding=3)

        self.l_chance = ttk.Label(self.root, text=m_loc["l_ast_chance"])
        self.e_chance = CChance(self.root)
        self.l_times = ttk.Label(self.root, text=m_loc["l_ast_times"])
        self.e_times = XEntry(self.root)
        self.l_weights = ttk.Label(self.root, text=m_loc["l_ast_weights"])
        ...
        self.l_deviation = ttk.Label(self.root, text=m_loc["l_ast_deviation"])
        self.e_deviation = XEntry(line_dev_plus_chance, width=6)
        self.l_dev_chance = ttk.Label(line_dev_plus_chance, text=m_loc["l_ast_dev_chance"])
        self.e_dev_chance = CChance(line_dev_plus_chance)
        self.l_dev_direction = ttk.Label(self.root, text=m_loc["l_ast_dev_direction"])
        self.e_dev_direction = CWeights(self.root, 2)
        self.l_dev_dir_hint = ttk.Label(self.root, text=m_loc["l_ast_dev_dir_hint"])
        ...
        self.l_force_pattern = ttk.Label(line_force_pattern, text=m_loc["l_ast_force_pattern"])
