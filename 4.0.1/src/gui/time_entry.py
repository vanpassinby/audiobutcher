...
class TimeEntry:
    ...
    def __init__(self, parent):
        ...
        self.part_label(loc["meta"]["time"]["hms"][0]).pack(side="left")
        self.minutes.pack(side="left")
        self.part_label(loc["meta"]["time"]["hms"][1]).pack(side="left")
        self.seconds.pack(side="left")
        self.part_label(loc["meta"]["time"]["hms"][2]).pack(side="left")
