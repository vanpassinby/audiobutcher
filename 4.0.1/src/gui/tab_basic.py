...
class SpeedChange:
    cb_speed_mode = BiDict(["semitones", "perc_change", "speed_mult"])
    cb_speed_affect = BiDict(["disabled", "to_main", "to_original"])

    def __init__(self, parent):
        m_loc = loc["tab_basic"]
        self.root = ttk.LabelFrame(parent, text=m_loc["f_speed_change"], padding=5)

        self.l_speed_main = ttk.Label(self.root, text=m_loc["l_speed_main"])
        self.e_speed_main = XEntry(self.root, width=10)
        self.c_speed_measure = YCombobox(self.root, width=loc["_geometry"]["cb_speed_measure"], state="readonly",
                                         items=self.cb_speed_mode, loc_part=m_loc["e_speed_alter"])
        self.l_speed_alter = ttk.Label(self.root, text=m_loc["l_speed_alter"])
        ...
        self.l_speed_variations = ttk.Label(self.root, text=m_loc["l_speed_variations"])
        self.e_speed_variations = XEntry(self.root)
        self.l_speed_weights = ttk.Label(self.root, text=m_loc["l_speed_weights"])
        self.e_speed_weights = XEntry(self.root)
        self.l_speed_affect_mode = ttk.Label(self.root, text=m_loc["l_speed_affect_mode"])
        self.c_speed_affect_mode = YCombobox(self.root, state="readonly", items=self.cb_speed_affect,
                                             loc_part=m_loc["c_speed_affect_mode"])
    ...
    def save_preset(self, preset: PresetSave):
        ...
        preset.add("speed_measure", self.c_speed_measure.get_str())
        ...
        preset.add("speed_affect_mode", self.c_speed_affect_mode.get_str())
...
class TabBasic:
    def __init__(self, parent):
        ...
        self.l_duration = ttk.Label(self.root, text=m_loc["l_duration"])
        self.e_duration = CDistribution(self.root)
        self.l_reverse1 = ttk.Label(self.root, text=m_loc["l_reverse1"])
        self.e_reverse1 = CChance(self.root)
        self.l_reverse2 = ttk.Label(self.root, text=m_loc["l_reverse2"])
        ...
        self.l_pause = ttk.Label(self.root, text=m_loc["l_pause"])
        self.e_pause = CDistribution(self.root)
        self.l_pause_chance = ttk.Label(self.root, text=m_loc["l_pause_chance"])
        self.e_pause_chance = CChance(self.root)
        self.l_consec_pause_chance = ttk.Label(self.root, text=m_loc["l_consec_pause_chance"])
        ...
        self.l_crossfade = ttk.Label(self.root, text=m_loc["l_crossfade"])
        self.e_crossfade = CDistribution(self.root)
        self.l_crossfade_chance = ttk.Label(self.root, text=m_loc["l_crossfade_chance"])
        ...
        self.l_fadein = ttk.Label(self.root, text=m_loc["l_fadein"])
        self.x_fadein_perc = CCheckbox(self.root, "%")
        self.e_fadein = CDistribution(self.root)
        self.l_fadein_chance = ttk.Label(self.root, text=m_loc["l_fadein_chance"])
        ...
        self.l_fade_only_into_pauses = ttk.Label(self.root, text=m_loc["l_fade_only_into_pauses"])
        ...
        self.l_fadeout = ttk.Label(self.root, text=m_loc["l_fadeout"])
        ...
        self.l_fadeout_chance = ttk.Label(self.root, text=m_loc["l_fadeout_chance"])
        self.e_fadeout_chance = CChance(self.root)
        self.x_fade_out_perc_note = CCheckbox(self.root, text=m_loc["x_fade_out_perc_note"])
        ...
        self.l_repeat = ttk.Label(self.root, text=m_loc["l_repeat"])
        self.e_repeat = CDistribution(self.root)
        self.l_repeat_chance = ttk.Label(self.root, text=m_loc["l_repeat_chance"])
        self.e_repeat_chance = CChance(self.root)
        self.x_repeat_in_mss = CCheckbox(self.root, text=m_loc["x_repeat_in_mss"])
        ...
        self.l_reappear = ttk.Label(self.root, text=m_loc["l_reappear"])
        self.e_reappear = CDistribution(self.root)
        self.l_reappear_chance = ttk.Label(self.root, text=m_loc["l_reappear_chance"])
        self.e_reappear_chance = CChance(self.root)
        self.l_reappear_reoccur_chance = ttk.Label(self.root, text=m_loc["l_reappear_reoccur_chance"])
