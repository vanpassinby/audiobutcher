...
class ScramblerConfig:
    def __init__(self):
        ...
        self.duration_priority: Optional[bool] = False
        ...
        self.framing_reverse_order: Optional[bool] = None
...
class ScramblerState:
    def __init__(self):
        ...
        self.abpl_marks: dict[int, set[str]] = {}
        self.abpl_constants: dict[str, Any] = {}
