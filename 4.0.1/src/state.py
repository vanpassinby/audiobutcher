...
PREFERENCES = [
    "unix_filenames", "show_error_info", "conv_sec2ms", "disable_completion_dialog", "_sep_",
    "audio_length_in_seconds", "export_length_in_seconds",
    "show_ffmpeg_formats", "remember_dnd_path", "open_scr_folder","_sep_",
    "visual_onsets_all", "slices_erase", "slices_auto", "slices_alt_auto"
]
